...
values."
  (setq-default
   ...
   '(
     ;; sr-speedbar # this is a stand alone package(not used by any layer)
     sr-speedbar
     )
...
you should place your code here."
  ...
  ;; Spacemacs as server daemon ;; not needed, just impliment emacsclient with -a=""
  ...
  ;; compile key binding
  ;; (global-set-key (kbd "<f5>") (lambda () (interactive) 'save-buffer 'compile))
  ...
  ;; orgmode settings
  ;; orgmode export line truncate always on #TODO : Not working
  ;; (add-hook 'org-mode-hook (lambda () (setq truncate-lines t)))
  ;; (add-hook 'org-mode-hook (lambda () (setq truncate-lines nil)))

  ;; org mode auto html export on save
  ...
  ;; working
  (add-hook 'org-mode-hook (lambda () (add-hook 'after-save-hook 'org-html-export-to-html nil t)))
  ...
  ;; Global company auto complete mode, always on  #TODO : Not working
  global-auto-complete-mode
  ;; Scale down font, till it is harcoaded in setting #TODO : Not working
  ;; spacemacs/scale-down-font
  ;; view +/- ascii instead of icons  in speedbar  #TODO : Not working any below
  (require 'sr-speedbar)
...
(custom-set-variables
 ...
 '(custom-safe-themes
   (quote
    ("bffa9739ce0752a37d9b1eee78fc00ba159748f50dc328af4be661484848e476" "b571f92c9bfaf4a28cb64ae4b4cdbda95241cd62cf07d942be44dc8f46c491f4" default)))
